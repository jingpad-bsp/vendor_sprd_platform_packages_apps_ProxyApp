...
package com.spreadtrum.proxy.controlsi;
 ...
 */
public class ProxyAppActivity extends AppCompatActivity {
    private static final String APPLICATION_ID = "com.spreadtrum.proxy.controlsi";
    private static final String TAG = "ControlSiLocationAttribution";
            ...
            public void onClick(View v) {
                if (isLocationPermissionGranted(Manifest.permission.ACCESS_FINE_LOCATION)) {
                    if (!isLocationPermissionGranted(
                        ...
                        if (ActivityCompat.shouldShowRequestPermissionRationale(ProxyAppActivity.this,
                                Manifest.permission.ACCESS_BACKGROUND_LOCATION)) {
