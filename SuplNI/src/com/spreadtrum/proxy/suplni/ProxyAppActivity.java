...
package com.spreadtrum.proxy.suplni;
...
public class ProxyAppActivity extends AppCompatActivity {
    private static final String APPLICATION_ID = "com.spreadtrum.proxy.suplni";
    private static final String TAG = "SuplNiLocationAttribution";
